...
mdLinksCli('C:/Users/Estefanía Telis/Documents/ProyectoNode', '--validate', '--stats').then(result => console.log(result)).catch(err => console.log(err)); // mdLinksCli('C:/Users/Estefanía Telis/Documents/ProyectoNode', undefined, undefined);